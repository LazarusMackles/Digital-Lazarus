...
export const Button: React.FC<ButtonProps> = ({ variant = 'primary', children, className = '', ...props }) => {
  ...
  const variantClasses = {
    primary: 'px-12 py-4 text-lg text-white bg-gradient-to-r from-cyan-600 to-fuchsia-600 shadow-lg shadow-cyan-500/30 hover:from-cyan-500 hover:to-fuchsia-500 hover:-translate-y-1',
