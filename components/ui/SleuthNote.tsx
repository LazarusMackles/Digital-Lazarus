...
export const SleuthNote: React.FC<SleuthNoteProps> = ({ children }) => {
  return (
    <div className="w-full max-w-xl text-center bg-slate-100 dark:bg-slate-900/50 px-4 pt-4 pb-6 rounded-xl border border-slate-200 dark:border-slate-700/50">
