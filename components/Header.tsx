    ...
    <header className="relative text-center">
      ...
      <div className="mt-4 max-w-2xl mx-auto bg-slate-100 dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-md">
        <p className="text-lg text-slate-800 dark:text-slate-200">
          In this brave new world of collaboration between humans and LLMs - clarity is key. Together let's analyse text, images, and URLs to trace their digital DNA and see if they've been enhanced by AI.
        </p>
      </div>
    </header>
  );
