...
export const Header: React.FC = React.memo(() => {
  ...
  return (
    <header className="w-full mb-6 flex items-center justify-center min-h-[3.5rem] px-2">
      
      <div className="flex flex-row items-center justify-center gap-3 sm:gap-6 max-w-full">
          
          {showHome && (
            <button
              onClick={handleReset}
              className="flex-shrink-0 p-1.5 sm:p-2 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-cyan-500 dark:hover:text-cyan-400 transition-all duration-300 group"
          ...
          <h1 className="py-2 text-xl sm:text-3xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-fuchsia-600 dark:from-cyan-400 dark:to-fuchsia-500 leading-tight tracking-tight text-center">
            Sleuther Vanguard
          </h1>
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <button
              ...
              className={cn(
                  "p-1 sm:p-1.5 rounded-full border transition-all duration-300 group",
                  isSystemReady 
            ...
            >
              <Icon name="cog" className="w-4 h-4 sm:w-5 h-5 group-hover:rotate-90 transition-transform duration-500" />
            </button>
            <ThemeToggle />
          </div>
