            ...
            >
                <div className="p-4 pt-2 text-sm text-slate-600 dark:text-slate-300">
                    <ul className="list-none space-y-3">
                        <li><strong className="text-slate-700 dark:text-slate-100">1. Submit Your Evidence:</strong> Upload an image to begin your investigation. For multiple images, the first is the <strong className="text-cyan-600 dark:text-cyan-400">Primary Evidence</strong>, and others serve as <strong className="text-cyan-600 dark:text-cyan-400">Supporting Context</strong>.</li>
                        <li><strong className="text-slate-700 dark:text-slate-100">2. Choose Your Investigation Angle:</strong>
                            <ul className="list-disc pl-5 mt-1 space-y-1">
                                ...
                                <li><strong className="text-cyan-600 dark:text-cyan-400">Provenance Dossier:</strong> A broader investigation that uses Google Search to find the image's history online, including its first appearance, context, and any public fact-checks.</li>
                            </ul>
                        </li>
                        <li><strong className="text-slate-700 dark:text-slate-100">3. Review the Findings:</strong> I'll return a <strong className="text-cyan-600 dark:text-cyan-400">Probability Score</strong> and a <strong className="text-cyan-600 dark:text-cyan-400">Detailed Verdict</strong>. My analysis is a professional opinion, not the undisputed truth.</li>
                        <li><strong className="text-slate-700 dark:text-slate-100">4. Engage with the Verdict:</strong> Not convinced? You can <strong className="text-cyan-600 dark:text-cyan-400">Request a Second Opinion</strong> for a new analysis. Your <strong className="text-cyan-600 dark:text-cyan-400">Feedback</strong> is also crucial—it helps sharpen my skills for the next case!</li>
                    </ul>
                </div>
            </div>
        </div>
