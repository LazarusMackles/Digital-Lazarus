            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8 border-t border-slate-200 dark:border-slate-700 pt-5">
                ...
                <div className="flex items-center gap-2">
                    <div className={cn(
                        "w-2 h-2 rounded-full transition-all duration-500",
                        hasHiveKeys 
                            ? "bg-fuchsia-500 shadow-[0_0_8px_rgba(217,70,239,0.8)] animate-pulse" 
                            : "bg-slate-400"
                    )} />
                ...
                <div className="flex items-center gap-2">
                    <div className={cn(
                        "w-2 h-2 rounded-full transition-all duration-500",
                        (hasGoogleApiKey && hasHiveKeys) 
                            ? "bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.8)]" 
                            : "bg-slate-400"
                    )} />
                    <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400">
                        {(hasGoogleApiKey && hasHiveKeys) ? "Vanguard Protocol Active" : "System Standby"}
                    </span>
                </div>
            </div>
        </div>
